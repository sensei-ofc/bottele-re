...
msgRetry,
msgRetryCache,
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['Bottle [ Prem Bot ]','Chrome','2.0.0'],
version: version,
...
m?.chat ? await conn.sendMessage(m.chat, {text: args[0] ? `@${m.sender.split('@')[0]}, ya estás conectado, leyendo mensajes entrantes...` : `> @${m.sender.split('@')[0]}, 𝖠𝗁𝗈𝗋𝖺 𝖾𝗋𝖾𝗌 𝗉𝖺𝗋𝗍𝖾 𝖽𝖾 𝗅𝖺 𝖿𝖺𝗆𝗂𝗅𝗂𝖺 *bottle bots* :𝖣`, mentions: [m.sender]}, { quoted: m }) : ''
}}
setInterval(async () => {
if (!sock.user) {
